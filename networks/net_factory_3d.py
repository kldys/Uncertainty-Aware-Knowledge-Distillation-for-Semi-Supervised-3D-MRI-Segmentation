from networks.unet_3D import unet_3D, unet_3D_dt,unet_3D_dt_c,unet_3D_Deform
...
def net_factory_3d(net_type="unet_3D", in_chns=1, class_num=2):
    ...
    elif net_type == "unet_3D_dt_c":
        net = unet_3D_dt_c(n_classes=class_num, in_channels=in_chns).cuda()
    ...
    elif net_type == "unet_3D_Deform":
        net = unet_3D_Deform(n_classes=class_num, in_channels=in_chns).cuda()
    else:
        net = None
    return net
