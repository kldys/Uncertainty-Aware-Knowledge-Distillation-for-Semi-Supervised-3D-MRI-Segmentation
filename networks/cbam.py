...
class spatial_attention(nn.Module):
    # 初始化，卷积核大小为7*7
    def __init__(self, in_channal = 2, out_channal =1, kernel_size=(3,3,1), padding_size=(1,1,0), init_stride=(1,1,1)):
        # 继承父类初始化方法
        ...
        self.conv = nn.Sequential(
                        nn.Conv3d(in_channal, out_channal, kernel_size, init_stride, padding_size),
                        nn.BatchNorm3d(1),
                        nn.Sigmoid(),
                          )
        # sigmoid函数
...
class cbam(nn.Module):
    ...
    def __init__(self, in_channel, ratio=16, kernel_size=(3,3,1)):
        # 继承父类初始化方法
